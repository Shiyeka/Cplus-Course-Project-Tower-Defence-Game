...
void MainWindow::paintEvent(QPaintEvent *)
{
    ...
    //画地图
    pt->drawPixmap(0, 0,1200,900,QPixmap(":/pic/picture/map1.jpg"));
    ...
    //画塔位
    int i;
    for(i=0;i<8;i++) { m_towerPositionsList[i].draw(pt); }  //有8个塔位
    //画塔、航点、敌人
...
{
    WayPoint *wayPoint1 = new WayPoint(QPoint(1160,630));
    m_wayPointsList.push_back(wayPoint1);

    WayPoint *wayPoint2 = new WayPoint(QPoint(870,630));
    m_wayPointsList.push_back(wayPoint2);
    wayPoint2->setNextWayPoint(wayPoint1);

    WayPoint *wayPoint3 = new WayPoint(QPoint(870,300));
    m_wayPointsList.push_back(wayPoint3);
    wayPoint3->setNextWayPoint(wayPoint2);

    WayPoint *wayPoint4 = new WayPoint(QPoint(570,300));
    m_wayPointsList.push_back(wayPoint4);
    wayPoint4->setNextWayPoint(wayPoint3);

    WayPoint *wayPoint5 = new WayPoint(QPoint(570,600));
    m_wayPointsList.push_back(wayPoint5);
    wayPoint5->setNextWayPoint(wayPoint4);

    WayPoint *wayPoint6 = new WayPoint(QPoint(340,600));
    m_wayPointsList.push_back(wayPoint6);
    wayPoint6->setNextWayPoint(wayPoint5);

    WayPoint *wayPoint7 = new WayPoint(QPoint(340,375));
    m_wayPointsList.push_back(wayPoint7);
    wayPoint7->setNextWayPoint(wayPoint6);

    WayPoint *wayPoint8 = new WayPoint(QPoint(0,375));
...
void MainWindow::removePoison(Poison *poison)
{
    delete poison;
    m_poison = NULL;
}
...
void MainWindow::on_pushButton_clicked()
{
    ...
    qDeleteAll(m_wayPointsList.begin(),m_wayPointsList.end());
    ...
    //操控塔防放置
        ...
        while (it != m_towerPositionsList.end())
        {
            ...
            it++;
              ...
              && m_canPoison)
    {
        m_poison = new Poison(playerme->getPos()+QPoint(30,30),360,2,this);
        m_poison->move();
        iconMove();
        m_canPoison = false;
...
void MainWindow::poisonEffect(Poison *poison)
{
    foreach(Enemy *enemy, m_enemyList)
    {
